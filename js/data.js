const courseData = [
  ...
  },
  {
    ...
    lessons: [
      ...
      { id: '05-syn-and-quote', number: '21.5', title: 'syn 与 quote', level: '进阶', duration: '40 分钟', tags: ['syn', 'quote', 'AST 解析', '代码生成', 'TokenStream 处理'] }
    ]
  },
  {
    ...
    lessons: [
      { id: '00-index', number: '', title: '高级特性', level: '入门', duration: '5 分钟', tags: ['关联类型', 'dyn Trait', '高级类型', '异步', '高级模式匹配', '格式化进阶'] },
      ...
      { id: '03-advanced-types', number: '22.3', title: '高级类型', level: '进阶', duration: '35 分钟', tags: ['高级类型', 'GAT', 'type alias impl Trait', '存在类型'] },
      { id: '04-async-basics', number: '22.4', title: '异步编程基础', level: '进阶', duration: '40 分钟', tags: ['异步', 'async/await', 'Future', 'tokio', 'async-std'] },
      { id: '05-advanced-patterns', number: '22.5', title: '模式匹配进阶', level: '进阶', duration: '25 分钟', tags: ['高级模式匹配', '@ 绑定', '模式守卫', 'ref 模式'] },
      { id: '06-advanced-formatting', number: '22.6', title: '格式化输出进阶', level: '进阶', duration: '20 分钟', tags: ['Display', 'Debug', 'format_args!', '自定义格式化'] }
    ]
  },
  {
