...
高级 ⏱ 30 分钟 模式匹配@ 绑定模式守卫解构matchif letwhile let
...
fn describe\_score(score: u32) \-> String { match score { 0..=59 => format!("不及格：{}", score), // ✅ 用到了 score 60..=79 => format!("良好：{}", score), // ✅ 但这里 score 只是原始变量 80..=100 => format!("优秀：{}", score), \_ \=> format!("无效分数：{}", score), } } fn main() {}
