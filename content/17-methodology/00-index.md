...
![ 方法论](/RustCourse/diagrams/method.svg)
...
[工程架构设计](./01-architecture)

如何把需求拆成模块？Cargo Workspace 怎么规划？

[编码流程与 TDD](./02-coding-flow)

先定结构体还是 Trait？怎么用测试驱动实现？

[Lint、Clippy 与 rustfmt](./03-lint)
