# 代码质量：Lint、Clippy 与 rustfmt

入门 ⏱ 25 分钟 lintclippyrustfmtcargo fmt#\[allow\]#\[deny\]代码质量
...
没有处理返回 `#[must_use]` 的值（如 `Result`）

`non_snake_case`

变量/函数不符合 snake\_case 命名规范
