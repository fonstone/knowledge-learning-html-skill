<p>代码能跑起来不代表代码是正确的。Rust 内置了完善的测试工具链——无需引入第三方库，<code>cargo test</code> 一条命令即可运行所有测试。</p>
<h2 id="本章目录">本章目录</h2>
