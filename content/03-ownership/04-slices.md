...
进阶 ⏱ 35 分钟 切片slice&str&\[T\]字符串切片数组切片range
...
![切片的原理](/RustCourse/diagrams/slice_string.svg)
...
可以接受 `&String`、字面量、切片，最灵活

可能修改字符串

`&mut String`

需要可变访问权限，只能传 `&mut String`
...
![切片的原理](/RustCourse/diagrams/slice.svg)
